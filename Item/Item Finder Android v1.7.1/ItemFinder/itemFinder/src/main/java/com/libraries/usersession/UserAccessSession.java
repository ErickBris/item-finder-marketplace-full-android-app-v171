...
public class UserAccessSession {
	...
	public void setFilterDistance(int radius) {
		editor.putInt(FILTER_RADIUS_DISTANCE, radius);
		editor.commit();
	}

	public int getFilterDistance() {
		return  sharedPref.getInt(FILTER_RADIUS_DISTANCE, 0);
	}

	public void setFilterDistanceMax(int radius) {
		editor.putInt(FILTER_RADIUS_DISTANCE_MAX, radius);
		editor.commit();
	}
