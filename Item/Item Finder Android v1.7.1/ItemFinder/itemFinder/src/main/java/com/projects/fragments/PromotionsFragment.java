...
public class PromotionsFragment extends Fragment implements OnItemClickListener, OnClickListener{
	...
	private void showList() {
		...
		adapter.setOnMGListAdapterAdapterListener(new OnMGListAdapterAdapterListener() {
			...
			public void OnMGListAdapterAdapterCreated(MGListAdapter adapter, View v,
				...
				imgViewPhoto.setBorderColor(getResources().getColor(UIConfig.THEME_MAIN_COLOR));
